...
export default function Custom404() {
  return (
    <div>
      <div className="lg:px-24 h-[70vh] lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
            ...
            {/* <div><img src="https://i.ibb.co/ck1SGFJ/Group.png" /></div> */}
      </div>
    </div>
  );
}