   ...
   <>
     <div className='w-full'>
            ...
            <div className='grid place-items-center'>
                <div className='px-5 pt-10 md:pt-10 justify-center text-center xl:text-left md:px-24 flex flex-col xl:flex-row items-center md:justify-between gap-10 md:gap-10 md:my-20'>
                    <div className='z-[10000]'>
                        <Image height={703} width={600} alt='hero img' src="/notAlone.svg" />
                    </div>
                    ...
                    <div className=' flex flex-col max-w-lg gap-6'>
                        ...
                        <div className='flex mx-auto md:mx-0 flex-col md:flex-row max-w-fit gap-5'>
                            <Link download="Vatebra Product Academy" href='/Product-Academy.pdf' className='text-base hover:bg-[#6a6363] cursor-pointer bg-[#ACACAC] text-black font-daxlineBold px-7 py-3 rounded-lg flex gap-5'>
        ...
        <div className='flex bg-[#ECEDEB] py-20 flex-col text-center px-5 md:px-24 justify-center items-center mt-32 gap-5'>
            <h1 className='md:w-[30rem] font-daxlineBold text-2xl'>Learn from seasoned industry experts <br /> and develop the ability to drive successful products.</h1>
            <h1 className='md:w-[45rem] font-daxlineMedium text-lg'>Product Managers are in charge of owning a product at every stage of its life cycle, from ideation to market success. To lead products and features to long term success, balance business viability, technical feasibility, and customer desire. 
            </h1>
            
                <Link href='/GetStarted' className='bg-[#D40E1F] mx-auto md:mx-0 text-white hover:bg-black font-daxlineRegular cursor-pointer max-w-fit px-10 py-3 rounded-lg'>Get Started</Link>
            ...
            <div className='grid place-items-center'>
                <div className='px-5 pt-10 md:pt-10 justify-center text-center xl:text-left md:px-24 flex flex-col xl:flex-row items-center md:justify-between gap-7 md:gap-10 md:my-20'>
                    <div className='z-[10000] xl:order-1'>
                        <Image height={703} width={600} alt='hero img' src="/africanSmilingLady.svg" />
                    </div>

                    <div className=' flex flex-col max-w-lg gap-6'>
                        <h1 className=' text-xl font-daxlineExtraBold'>Accelerate Your Product Management Career; Learn the Best Product Management Practices, Led by Experienced Product Leaders</h1>
                        <h1 className='text-[#030303] font-daxlineMedium text-base opacity-80 max-w-4xl  md:text-xl'>Product Managers are in charge of owning a product at every stage of its life cycle, from ideation to market success. To lead products and features to long term success, balance business viability, technical feasibility, and customer desire. 
                        </h1>
