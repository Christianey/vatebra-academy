...
const MakePayment = () => {
  ...
  return (
   <>
         <div className=''>
         <Image height={600} width={1500} src='/makePaymentHeroImg.svg' alt='aboutHeroImg' className='w-full' />
         <h1 className='text-center py-10 text-5xl font-daxlineExtraBold text-[#CB1829]'>All Programs</h1>
       ...
       <div className='bg-[#ECEDEB] mx- p-5 flex flex-col justify-center flex-wrap md:flex-row gap-10 md:gap-20'>
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        <Image src='/price.svg' width={180} height={70} alt='price' />
                        <h1 onClick={() => setShowDataBrooderModal(!showDataBrooderModal)} className='mt-6 text-lg font-daxlineBold hover:underline cursor-pointer'>Program details</h1>
                    </div>

                        <h1 className=' text-3xl font-daxlineExtraBold text-[#CA28E8]'>DATA BROODER</h1>

                    <div className='flex mx-auto md:mx-0 flex-col md:flex-row max-w-fit gap-5 border-t-2 border-gray-500 py-5'>
                        <Link download="Vatebra Data Brooder" href='/Vatebra Data Brooder.pdf' className='text-base hover:bg-gray-500 cursor-pointer bg-gray-400 text-black font-daxlineBold px-7 py-3 rounded-lg flex gap-5'>
            ...
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        <Image src='/price.svg' width={180} height={70} alt='price' />
                        <h1 className='mt-6 text-lg font-daxlineBold hover:underline cursor-pointer'>Program details</h1>
                    </div>

                        <h1 className=' text-3xl font-daxlineExtraBold text-[#5CBF22]'>DATA SCIENCE</h1>

                    <div className='flex mx-auto md:mx-0 flex-col md:flex-row max-w-fit gap-5 border-t-2 border-gray-500 py-5'>
                        <Link download="Vatebra Data Science" href='/Vatebra Data Science.pdf' className='text-base hover:bg-gray-500 cursor-pointer bg-gray-400 text-black font-daxlineBold px-7 py-3 rounded-lg flex gap-5'>
                                <h1 className='text-white'>Download broachure</h1>
                                <Image height={20} width={28} alt='line' src="/downloadLogo.svg" />
                        </Link>
                        <Link target='_blank' href='https://paystack.com/pay/f7jf3lscts' className='bg-[#D40E1F] mx-auto md:mx-0 font-daxlineRegular cursor-pointer max-w-fit text-white hover:bg-slate-700 px-10 py-3 rounded-lg'>Pay now</Link>                    
            ...
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        ...
                        <h1 className=' text-3xl font-daxlineExtraBold text-[#FC5A5F]'>DATA ANALYTICS</h1>

                    <div className='flex mx-auto md:mx-0 flex-col md:flex-row max-w-fit gap-5 border-t-2 border-gray-500 py-5'>
                        <Link download="Vatebra Data Analytics" href='/Vatebra Data Analytics.pdf' className='text-base hover:bg-gray-500 cursor-pointer bg-gray-400 text-black font-daxlineBold px-7 py-3 rounded-lg flex gap-5'>
                            <h1 className='text-white'>Download broachure</h1>
                            <Image height={20} width={28} alt='line' src="/downloadLogo.svg" />
                        </Link>
                        <Link target='_blank' href='https://paystack.com/pay/f7jf3lscts' className='bg-[#D40E1F] mx-auto md:mx-0 font-daxlineRegular cursor-pointer max-w-fit text-white hover:bg-slate-700 px-10 py-3 rounded-lg'>Pay now</Link> 
            ...
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        ...
                        <h1 className=' text-3xl font-daxlineExtraBold text-[#1B7E8A]'>SCRUM-MASTER</h1>

                    <div className='flex mx-auto md:mx-0 flex-col md:flex-row max-w-fit gap-5 border-t-2 border-gray-500 py-5'>
                        <div className='text-base hover:bg-gray-500 cursor-pointer bg-gray-400 text-black font-daxlineBold px-7 py-3 rounded-lg flex gap-5'>
                                <h1 className='text-white'>Download broachure</h1>
                                <Image height={20} width={28} alt='line' src="/downloadLogo.svg" />
                        </div>
                        <Link target='_blank' href='https://paystack.com/pay/f7jf3lscts' className='bg-[#D40E1F] mx-auto md:mx-0 font-daxlineRegular cursor-pointer max-w-fit text-white hover:bg-slate-700 px-10 py-3 rounded-lg'>Pay now</Link>                   
            ...
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        ...
                        <h1 className=' text-3xl font-daxlineExtraBold text-[#108FFC]'>UI/UX DESIGNER</h1>

                    <div className='flex mx-auto md:mx-0 flex-col md:flex-row max-w-fit gap-5 border-t-2 border-gray-500 py-5'>
                        <Link download="Design Academy" href='/Design-Academy.pdf' className='text-base hover:bg-gray-500 cursor-pointer bg-gray-400 text-black font-daxlineBold px-7 py-3 rounded-lg flex gap-5'>
                                <h1 className='text-white'>Download broachure</h1>
                                <Image height={20} width={28} alt='line' src="/downloadLogo.svg" />
                        </Link>
                        <Link target='_blank' href='https://paystack.com/pay/f7jf3lscts' className='bg-[#D40E1F] mx-auto md:mx-0 font-daxlineRegular cursor-pointer max-w-fit text-white hover:bg-slate-700 px-10 py-3 rounded-lg'>Pay now</Link>                    
       ...
       <Image height={600} width={500} src='/choose.svg' alt='aboutHeroImg' className='w-full' />
       ...
       <div className='bg-[#ECEDEB] mb-20 p-5 flex flex-col justify-center flex-wrap md:flex-row gap-10 md:gap-20'>
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        ...
                        <h1 className=' text-3xl font-daxlineExtraBold text-[#CA28E8]'>PRODUCT MANAGEMENT</h1>

                    <div className='flex mx-auto md:mx-0 flex-col md:flex-row max-w-fit gap-5 border-t-2 border-gray-500 py-5'>
                        <Link download="Product Academy" href='/product Academy.pdf' className='text-base hover:bg-gray-500 cursor-pointer bg-gray-400 text-black font-daxlineBold px-7 py-3 rounded-lg flex gap-5'>
                                <h1 className='text-white'>Download broachure</h1>
                                <Image height={20} width={28} alt='line' src="/downloadLogo.svg" />
                        </Link>
                        <Link target='_blank' href='https://paystack.com/pay/f7jf3lscts' className='bg-[#D40E1F] mx-auto md:mx-0 font-daxlineRegular cursor-pointer max-w-fit text-white hover:bg-slate-700 px-10 py-3 rounded-lg'>Pay now</Link>                    
            ...
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        ...
                        <h1 className=' text-3xl font-daxlineExtraBold text-[#5CBF22]'>PROJECT MANAGEMENT</h1>
            ...
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        ...
                        <h1 className=' text-3xl font-daxlineExtraBold text-[#FC5A5F]'>BACK-END ENGINEERING</h1>

                    <div className='flex mx-auto md:mx-0 flex-col md:flex-row max-w-fit gap-5 border-t-2 border-gray-500 py-5'>
                        <Link  download="Backend" href='/Backend.pdf' className='text-base hover:bg-gray-500 cursor-pointer bg-gray-400 text-black font-daxlineBold px-7 py-3 rounded-lg flex gap-5'>
                                <h1 className='text-white'>Download broachure</h1>
                                <Image height={20} width={28} alt='line' src="/downloadLogo.svg" />
                        </Link>
            ...
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    ...
                    <h1 className=' text-3xl font-daxlineExtraBold text-[#5CBF22]'>FULL-STACK PROGRAMMING</h1>

                    <div className='flex mx-auto md:mx-0 flex-col md:flex-row max-w-fit gap-5 border-t-2 border-gray-500 py-5'>
                        <Link download="Vatebra Full Stack" href='/Full stack Dev.pdf' className='text-base hover:bg-gray-500 cursor-pointer bg-gray-400 text-black font-daxlineBold px-7 py-3 rounded-lg flex gap-5'>
                                <h1 className='text-white'>Download broachure</h1>
                                <Image height={20} width={28} alt='line' src="/downloadLogo.svg" />
                        </Link>
                        <Link target='_blank' href='https://paystack.com/pay/f7jf3lscts' className='bg-[#D40E1F] mx-auto md:mx-0 font-daxlineRegular cursor-pointer max-w-fit text-white hover:bg-slate-700 px-10 py-3 rounded-lg'>Pay now</Link>                    
            ...
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        ...
                        <h1 className=' text-3xl font-daxlineExtraBold text-[#1B7E8A]'>DOTNET PROGRAMMING</h1>
            ...
            <div className='bg-white grid place-items-center gap-7 md:w-[30rem] py-5 rounded-2xl'>
                    <div className='flex items-center justify-around w-full'>
                        ...
                        <h1 className=' text-3xl font-daxlineExtraBold text-[#108FFC]'>SYSTEM ARCHITECTURE</h1>
        ...
        <div className='grid place-items-center'>
            <div className='px-5 pt-10 md:pt-10 justify-center text-center xl:text-left md:px-24 flex flex-col xl:flex-row items-center md:justify-between gap-20'>
                <div className='z-[10000]'>
                    <Image height={703} width={745} alt='hero img' src="/whyImgInMakePayment.svg" />
                </div>
                ...
                <div className=' flex flex-col max-w-2xl gap-6'>
                    ...
                    <button className='bg-[#D40E1F] md:w-[max-content] py-3 px-24 hover:bg-black rounded-lg mx-auto xl:mx-0 text-white font-daxlineBold'>Get started</button> 
                    </Link> 
                </div>
       ...
       <div className='bg-[#5CBF22] px-5 grid place-items-center py-20 mt-20'>
            <div className='bg-[#1B390A] md:w-[55rem] py-10 px-5 md:px-14 rounded-2xl text-white flex justify-center items-center flex-col gap-12'>
                <h1 className='text-center text-3xl font-daxlineBold'>Whether you’re just starting out or looking to upskill, we have courses that will help you achieve your career goals.</h1>
                <Link href='GetStarted' className='text-center max-w-fit hover:bg-black text-xl font-daxlineBold px-20 py-2 rounded-lg bg-[#CB1829]'>Explore courses</Link>
            </div>
       </div>
         </div>
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full p-5 bg-white outline-none focus:outline-none">
                                ...
                                <form className='flex flex-col gap-7 md:gap-10 '>
                                    ...
                                    <div className='w-full'>
                                        ...
                                        <textarea readOnly value='The Data Analytics Programs helps you grasp analytics and the ways it is reshaping the future of work, we anticipate an exciting 2–month immersive learning experience. Live lectures, interactive examples, and immersive group projects will be used to help you enhance your skills in large data processing. Querying and Visualization using Advanced Excel, Structured Query Language (SQL) and Microsoft Power Business Intelligence.
                                        The Data Analytics Programs helps you grasp analytics and the ways it is reshaping the future of work, we anticipate an exciting 2–month immersive learning experience. Live lectures, interactive examples, and immersive group projects will be used to help you enhance your skills in large data processing. Querying and Visualization using Advanced Excel, Structured Query Language (SQL) and Microsoft Power Business Intelligence.' type="email" placeholder='Enter your email address' className=' border-opacity-10 border w-full h-32 py-5 p-3 px-8' />
                                    </div>
                                    </div>
                                </form>
                                ...
                                <button
                                    ...
                                    type="submit"
                                    onClick={() => {setShowModal(true), setShowDataBrooderModal(false)}}
                                >
                                    Proceed to payment
                                </button>
                                </div>
                        ...
                        >
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full p-5 bg-white outline-none focus:outline-none">
                                ...
                                <button
                                    className="bg-[#D40E1F] text-white active:bg-emerald-600 px-14 cursor-pointer font-bold uppercase text-sm py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                    type="submit"
                                    onClick={() => {setShowModal(true), setShowModal2(false)}}
                                >
                                    Proceed to payment
                                </button>
                                </div>
