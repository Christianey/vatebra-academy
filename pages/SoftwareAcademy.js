              ...
              <div className=" text-white flex flex-col xl:flex-row  gap-5 justify-center">
                <div className=" md:w-[35rem] bg-white flex flex-col gap-10 p-10 rounded-3xl">
                  <div className="flex gap-5 flex-wrap">
                    ...
                    <h1
                      onClick={() => setFrontendModal(!frontendModal)}
                  ...
                  <div className="flex flex-col md:flex-row max-w-fit gap-5">
                    <Link
                      download="Vatebra Frontend"
                      href="/Front end Dev.pdf"
                ...
                <div className=" md:w-[35rem] bg-white flex flex-col gap-10 p-10 rounded-3xl">
                  <div className="flex gap-5 flex-wrap">
                    ...
                    <h1
                      onClick={() => setBackendModal(!backend)}
                      className="border-gray-400 border text-black font-daxlineRegular hover:bg-gray-400 hover:text-white max-w-fit cursor-pointer px-5 p-1 rounded-full"
                    >
                      Program details
                    </h1>
              ...
              <div className=" text-white flex flex-col xl:flex-row  gap-5 justify-center">
                <div className=" md:w-[35rem] bg-white flex flex-col gap-10 p-10 rounded-3xl">
                  <div className="flex gap-5 flex-wrap">
                    ...
                    <h1
                      onClick={() => setFullstackModal(!fullstackModal)}
                      className="border-gray-400 border text-black font-daxlineRegular hover:bg-gray-400 hover:text-white max-w-fit cursor-pointer px-5 p-1 rounded-full"
                    >
                      Program details
                    </h1>
                ...
                <div className=" md:w-[35rem] bg-white flex flex-col gap-10 p-10 rounded-3xl">
                  <div className="flex gap-5 flex-wrap">
                    <h1 className="text-2xl font-daxlineExtraBold text-[#338603]">
                      DotNet Stack Programming
                    </h1>
                    <h1 className="border-gray-400 border text-black font-daxlineRegular hover:bg-gray-400 hover:text-white max-w-fit cursor-pointer px-5 p-1 rounded-full">
                      Program details
                    </h1>
                  </div>
                  <p className=" text-lg font-daxlineBold text-[#E8AC28]">
                    ...
                    <div className="flex flex-col xl:flex-row gap-5 xl:gap-32">
                      <div>
                        ...
                        <h1 className="mb-3 font-daxlineMedium text-sm opacity-75 w-96 md:w-[45rem]">
                          ...
                          advancing you from Enthusiast/Zero Level to a Software
                          Developer ready to build world-class tech solutions.
                          Learn how to create your own entire websites from
                          scratch! starting with software engineering’s
                          fundamentals. You would have mastered a specialty and
                          learned the art of productive teamwork by the time
                  ...
                  <form className="flex flex-col gap-7 md:gap-10 ">
                    <div className="flex flex-col xl:flex-row gap-5 xl:gap-32">
                      <div>
                        ...
                        <h1 className="mb-3 font-daxlineMedium text-sm opacity-75 w-96 md:w-[45rem]">
                          This course is intended to serve as a job workshop.
                          The main goal is to teach our students all the aspects
                          of job prospecting necessary to find employment in
                          three months. Key Competencies: Cover letter,
                          Industry-standard CV, Interview Demo-Class, LinkedIn
                          Optimization
                        </h1>
                      </div>
                      <div>
                    ...
                    <div className="flex flex-col md:flex-row w-full">
                      <div className="w-full">
                        ...
                        <textarea
                          readOnly
                          value="This course is intended to serve as a job workshop. The main goal is to teach our students all the 
aspects of job prospecting necessary to find employment in three months.
Key Competencies: Cover letter, Industry-standard CV, Interview Demo-Class, LinkedIn Optimization"
                          type="email"
                          placeholder="Enter your email address"
                          className=" border-opacity-10 border w-full h-32 py-5 p-3 px-8"
                        />
