...
const Academies2 = () => {
  ...
  return (
    <>
        <div className='px-5 md:px-10 m-10 bg-white mx-5 md:mx-6 py-20 md:my-32 my-20 shadow-2xl rounded-3xl md:grid md:place-items-center justify-around flex flex-col xl:flex xl:flex-row gap-10'>
            <div className='text-center rounded-3xl bg-white shadow-2xl p-6 flex flex-col gap-7 md:text-left md:w-[40rem] 2xl:w-[50rem]'>
                <Image height={351} width={600} src='/productDesignAcademy.svg' alt='get started Data Academy image' className='2xl:w-[37rem]' />
                <div className='flex flex-col md:flex-row justify-between items-center'>
                        <h1 className='font-daxlineExtraBold text-2xl'>Product Design Academy</h1>
                        <h1 onClick={() => setShowDataAcademyModal(!showDataAcademyModal)} className='mt-6 text-lg font-daxlineBold hover:underline cursor-pointer'>Program details</h1>
                </div>
                <p className=' opacity-80 text-lg font-daxlineMedium'>The Vatebra Program Data School aids with your quick transition into one of the most sought-after in the digital industry. We assist you in accelerating your professional growth within a few months with a set of thoughtfully created business-focused data tools learning materials.</p>
                <div className='flex mx-auto md:mx-0 items-center justify-between flex-col md:flex-row max-w-fit gap-5'>
                    <Link href='/ProductAcademy' className='bg-[#D40E1F] mx-auto md:mx-0 text-white font-daxlineRegular hover:bg-black px-4 py-2 cursor-pointer max-w-fit rounded-lg'>Enroll now</Link>
                    ...
                    <div className='text-base hover:bg-slate-300 cursor-pointer px-5 py-2 bg-gray-500 text-black font-daxlineBold rounded-lg items-center flex gap-2'>
                        <Link download="Vatebra Design Academy" href='/Design-Academy.pdf' className='text-white hover:text-black'>Download broachure</Link>
                    ...
                    <div className='flex flex-col text-sm'>
                        ...
                        <Link href='tel:+2348038320933' className='cursor-pointer font-daxlineBold'>+234 803 832 0933</Link>
                    </div>
                </div>
            </div>

            <div className='text-center rounded-3xl bg-white shadow-2xl p-6 flex flex-col gap-7 md:text-left md:w-[40rem] 2xl:w-[50rem]'>
                <Image height={351} width={600} src='/getStartedSoftwareAcademy.svg' alt='get started Data Academy image' className='2xl:w-[37rem]' />
                <div className='flex flex-col md:flex-row justify-between items-center'>
                        <h1 className='font-daxlineExtraBold text-2xl'>Software Academy</h1>
                        <h1 onClick={() => setShowProductAcademyModal(!showProductAcademyModal)} className='mt-6 text-lg font-daxlineBold hover:underline cursor-pointer'>Program details</h1>
                </div>
                <p className=' opacity-80 text-lg font-daxlineMedium'>The Vatebra Program Data School aids with your quick transition into one of the most sought-after in the digital industry. We assist you in accelerating your professional growth within a few months with a set of thoughtfully created business-focused data tools learning materials.</p>
                <div className='flex mx-auto md:mx-0 items-center justify-between flex-col md:flex-row max-w-fit gap-5'>
                    <Link href='/SoftwareAcademy' className='bg-[#D40E1F] mx-auto md:mx-0 text-white font-daxlineRegular hover:bg-black px-4 py-2 cursor-pointer max-w-fit rounded-lg'>Enroll now</Link>

                    <div className='text-base hover:bg-slate-300 cursor-pointer px-5 py-2 bg-gray-500 text-black font-daxlineBold rounded-lg items-center flex gap-2'>
                        <h1 className='text-white hover:text-black'>Download broachure</h1>
                        <Image height={20} width={28} alt='line' src="/downloadLogo.svg" />
                    </div>
                    <div className=' hidden md:block bg-[#707070] w-1 rounded-3xl h-10'></div>
                    <div className='flex flex-col text-sm'>
                ...
                <div className="relative font-daxlineBold p-6 flex-auto">
                  <form className='flex flex-col gap-7 md:gap-10 '>
                    <div className='flex flex-col xl:flex-row gap-5 xl:gap-32'>
                      <div>
                        <h1 className=' font-daxlineBold text-[#5CBF22] mb-5 text-2xl'>Product Design Academy</h1>
                        <h1 className='mb-3 font-daxlineMedium text-sm opacity-75 w-96 md:w-[45rem]'>You will begin yourjourney by learning how to apply design thinking practices to productdevelopment
and buy-in strategies,allowing you to gain a better understanding of the real-world market, maximize
positive outcomes, and understand your customers’thought the processes</h1>
                    ...
                    <div className='flex flex-col md:flex-row w-full'>
                      <div className='w-full'>
                        ...
                        <textarea readOnly value='Exploring UI/UX 
- Interface Design vs ProductDesign
- Roles of UI/UX Designers
- UI/UX Rules
Design Fundamentals
- Contrast, white spacing, Alignment, visual Hierarchy, consistency, scale etc
- Introduction to Figma
- Wireframes to Prototyping: Converting Paper
wireframes to low fidelitymockup' type="email" placeholder='Enter your email address' className=' border-opacity-10 border w-full h-32 py-5 p-3 px-8' />
                      </div>
                    </div>
                  </form>
                ...
                <div className="flex items-center justify-start p-6 rounded-b">
                  ...
                  <button
                    ...
                    type="submit"
                    onClick={() => {setShowModal(true), setShowDataAcademyModal(false)}}
                  >
                    Proceed to payment
                  </button>
                </div>
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full p-5 bg-white outline-none focus:outline-none">
                ...
                <div className="relative font-daxlineBold p-6 flex-auto">
                  <form className='flex flex-col gap-7 md:gap-10 '>
                    <div className='flex flex-col xl:flex-row gap-5 xl:gap-32'>
                      <div>
                        <h1 className=' font-daxlineBold text-[#5CBF22] mb-5 text-2xl'>Software Academy</h1>
...
Learn how to create your own entire websites from scratch! starting with software engineering’s 
fundamentals. You would have mastered a specialty and learned the art of productive teamwork by 
the time this program is over.
This training is designed by top professionals to provide in-depth knowledge to beginners while 
also establishing a leading industry relationship that leads to job opportunities.' type="email" placeholder='Enter your email address' className=' border-opacity-10 border w-full h-32 py-5 p-3 px-8' />
                      </div>
                    </div>
                  </form>
                  {/* <p className="my-4 text-slate-500 text-lg leading-relaxed">
                ...
                <div className="flex items-center justify-start p-6 rounded-b">
                  ...
                  <button
                    className="bg-[#D40E1F] text-white active:bg-emerald-600 px-14 cursor-pointer font-bold uppercase text-sm py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="submit"
                    onClick={() => {setShowModal(true), setShowProductAcademyModal(false)}}
                  >
                    Proceed to payment
                  </button>
                </div>
