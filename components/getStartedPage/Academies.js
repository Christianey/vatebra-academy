    ...
    <>
      <div className='px-5 md:px-10 m-10 bg-white mx-5 md:mx-6 py-20 shadow-2xl rounded-3xl md:grid md:place-items-center justify-around flex flex-col xl:flex xl:flex-row gap-10'>
        <div className='text-center rounded-3xl bg-white shadow-2xl p-6 flex flex-col gap-7 md:text-left md:w-[40rem] 2xl:w-[50rem]'>
          <Image height={351} width={600} src='/getStartedDataAcademy.svg' alt='get started Data Academy image' className='2xl:w-[37rem]' />
          ...
          <div className='flex mx-auto md:mx-0 items-center justify-between flex-col md:flex-row max-w-fit gap-5'>
            <Link href='/DataAcademy' className='bg-[#D40E1F] mx-auto md:mx-0 text-white font-daxlineRegular hover:bg-black px-4 py-2 cursor-pointer max-w-fit rounded-lg'>Enroll now</Link>
            ...
            <div className='text-base hover:bg-slate-300 cursor-pointer px-5 py-2 bg-gray-500 text-black font-daxlineBold rounded-lg items-center flex gap-2'>
              <Link download="Vatebra Data Academy" href='/Vatebra-Data-Academy.zip' className='text-white hover:text-black'>Download broachure</Link>
        ...
        <div className='text-center rounded-3xl bg-white shadow-2xl p-6 flex flex-col gap-7 md:text-left md:w-[40rem] 2xl:w-[50rem]'>
          <Image height={351} width={600} src='/getStartedDataAcademy2.svg' alt='get started Data Academy image' className='2xl:w-[37rem]' />
          <div className='flex flex-col md:flex-row justify-between items-center'>
          ...
          <p className=' opacity-80 text-lg font-daxlineMedium'>The Vatebra Program Data School aids with your quick transition into one of the most sought-after in the digital industry. We assist you in accelerating your professional growth within a few months with a set of thoughtfully created business-focused data tools learning materials.</p>
          <div className='flex mx-auto md:mx-0 items-center justify-between flex-col md:flex-row max-w-fit gap-5'>
            <Link href='/ProductAcademy' className='bg-[#D40E1F] mx-auto md:mx-0 text-white font-daxlineRegular px-4 py-2 cursor-pointer max-w-fit rounded-lg'>Enroll now</Link>

            <div className='text-base hover:bg-slate-300 cursor-pointer px-5 py-2 bg-gray-500 text-black font-daxlineBold rounded-lg items-center flex gap-2'>
              <Link download="Vatebra Product Academy" href='/Product-Academy.pdf' className='text-white hover:text-black'>Download broachure</Link>
              <Image height={20} width={28} alt='line' src="/downloadLogo.svg" />
            </div>
            <div className=' hidden md:block bg-[#707070] w-1 rounded-3xl h-10'></div>
            <div className='flex flex-col text-sm'>
                  ...
                  <form className='flex flex-col gap-7 md:gap-10 '>
                    <div className='flex flex-col xl:flex-row gap-5 xl:gap-32'>
                      <div>
                        ...
                        <h1 className='mb-3 font-daxlineMedium text-sm opacity-75 w-96 md:w-[45rem]'>The Vatebra Program Data School aids with your quick transition into one of the most sought-after in the digital industry. We assist you in accelerating your professional growth within a few months with a set of thoughtfully created business-focused data tools learning materials.</h1>
                    ...
                    <div className='flex flex-col md:flex-row w-full'>
                      <div className='w-full'>
                        ...
                        <textarea readOnly value='The Vatebra Program Data School aids with your quick transition into one of the most sought-after in the digital industry. We assist you in accelerating your professional growth within a few months with a set of thoughtfully created business-focused data tools learning materials.' type="email" placeholder='Enter your email address' className=' border-opacity-10 border w-full h-32 py-5 p-3 px-8' />
                      </div>
                    </div>
                  </form>
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full p-5 bg-white outline-none focus:outline-none">
                ...
                <div className="relative font-daxlineBold p-6 flex-auto">
                  <form className='flex flex-col gap-7 md:gap-10 '>
                    <div className='flex flex-col xl:flex-row gap-5 xl:gap-32'>
                      <div>
                        <h1 className=' font-daxlineBold text-[#5CBF22] mb-5 text-2xl'>Product Academy</h1>
                        <h1 className='mb-3 font-daxlineMedium text-sm opacity-75 w-96 md:w-[45rem]'>This intensive training takes a hands-on approach to advancing you from      Enthusiast/Zero Level to
                          ...
                          establishing a leading industry relationship that leads to job opportunities. </h1>
                    ...
                    <div className='flex flex-col md:flex-row w-full'>
                      <div className='w-full'>
                        ...
                        <textarea readOnly value='This intensive training takes a hands-on approach to advancing you from Enthusiast/Zero Level to 
                          Product Manager ready to build world-class products. 
                          This training is designed by top professionals to provide in-depth knowledge to beginners while also 
                          establishing a leading industry relationship that leads to job opportunities. ' type="email" placeholder='Enter your email address' className=' border-opacity-10 border w-full h-32 py-5 p-3 px-8' />
                      </div>
                    </div>
                  </form>
                  {/* <p className="my-4 text-slate-500 text-lg leading-relaxed">
