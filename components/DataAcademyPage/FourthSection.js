        ...
        <div className="grid place-items-center">
          <div className="px-5 bg-white shadow-2xl py-16 rounded-3xl md:pt-10 justify-center text-center xl:text-left md:px-24 flex flex-col xl:flex-row items-center md:justify-between gap-5 md:gap-20">
            ...
            <div className=" flex flex-col max-w-2xl gap-6">
              <h1 className="text-3xl font-daxlineExtraBold md:text-4xl">
                Why Data School?
              </h1>

              <h3 className=" font-daxlineExtraBold">
                The Vatebra Program Data School aids with your quick transition
                into one of the most sought-after in the digital industry.{" "}
              </h3>

              <h1 className="text-[#030303] font-daxlineMedium max-w-4xl opacity-90 md:text-base">
                We assist you in accelerating your professional growth within a
                few months with a set of thoughtfully created business-focused
                data tools learning materials
              </h1>
