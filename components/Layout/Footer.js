...
const Footer = () => {
  ...
  return (
    <div className={`${clicked && 'hidden'} flex gap-10 bg-[#FCF3DF] pt-20 pb-10 flex-col xl:flex-row xl:justify-between px-5 md:px-24`}>
      ...
      <div>
        <div className='flex gap-10 flex-col md:flex-row xl:gap-24 md:justify-between border-b border-[#707070]'>
          ...
          <div className='flex flex-col gap-8 mb-5'>
             <h1 className=' font-daxlineBold text-lg  text-[#1F2829]'>Company Contact</h1>
            <div className='flex flex-col gap-8 items-start font-daxlineBold text-base text-[#0B3954]'>
              <a className='flex items-center gap-4' href='tel:+2349062547247'>
                <Image height={24} width={24} src="/phoneLogo.svg" alt='Phone logo' />
                <h1>2349062547247</h1>
              </a>
              <a className='flex items-center gap-4' href='mailto:customersupport@vatebra.com'>
                <Image height={17} width={25} src="/mailLogo.svg" alt='Phone logo' />
        ...
        <div className='flex flex-col md:flex-row mt-5 items-center md:justify-around xl:justify-between  text-base font-daxlineRegular text-[#0B3954]'>
          <div className='flex gap-10 '>
            <a className='flex items-center gap-4' href='#'>
              <Image height={41} width={41} src="/facebook.svg" alt='facebook logo' />
            </a>
            <a className='flex items-center gap-4' href='#'>
              <Image height={41} width={41} src="/twitter.svg" alt='twitter logo' />
            </a>
            <a className='flex items-center gap-4' href='#'>
              <Image height={41} width={41} src="/instagram.svg" alt='instagram logo' />
            </a>
            <a className='flex items-center gap-4' href='#'>
              <Image height={41} width={41} src="/pinIntrest.svg" alt='pinIntrest logo' />
            </a>
          </div>
